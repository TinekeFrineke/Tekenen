...
bool BitmapButtonBase::LoadBitmap(LPCTSTR bitmapname, BmpInfo & anInfo)
{
...
void SingleBitmapButton::SetBitmap(int iResource)
{
  LoadBitmap(MAKEINTRESOURCE(iResource), mBitmap);
...
void DoubleBitmapButton::SetBitmap(int iResource, int iPressedResource)
{
  LoadBitmap(MAKEINTRESOURCE(iResource),        mBitmap);
  LoadBitmap(MAKEINTRESOURCE(iPressedResource), mPressedBitmap);
...
void VariableBitmapButton::SetBitmap(const std::tstring & aBitmap)
{
  RECT rect;
  GetClientRect(rect);
